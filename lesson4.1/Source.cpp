 ...
 * 2. Определить зависимость времени работы быстрой сортировки (сортировка Хоара/сортировка слиянием)  от числа элементов массива
 - Смотри график 5.
 * 3. Определить количество элементов массива при котором медленная сортировка работает быстрее быстрой. - Примерно 10, но пределить сложно
 ...
 * 5. Определить зависимость времени работы бинарного поиска от количества элементов массива и количества запросов поиска
 - Смотри график 6. Это зависимость от числа запросов, а зависимость от числа элементов массиво равно константе, так как
